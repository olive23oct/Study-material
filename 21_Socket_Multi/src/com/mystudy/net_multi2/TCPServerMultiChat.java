...
public class TCPServerMultiChat {
	...
	//서버소켓 생성하고 대기하다가
	//클라이언트가 접속하면 메시지를 받기 위한 쓰레드 생성(메시지 읽고 전체에게 전달)
	...
	//생성될 때 : 필드 clents 에 추가
	//종료될 때 : 필드 clents 에서 삭제 처리
	private class ServerReceiver extends Thread {
		...
		ServerReceiver(Socket socket) {//연결된 Socket 받아
			this.socket = socket;
